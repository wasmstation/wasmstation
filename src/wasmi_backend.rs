//! A [`Backend`] based on the [`wasmi`] WebAssembly engine.

extern crate alloc;

use core::{array, str};

use crate::core::{framebuffer, utils, wasm4, Api, Backend, Console, Sink, Source};
...
/// A `no_std` backend for WebAssembly games.
